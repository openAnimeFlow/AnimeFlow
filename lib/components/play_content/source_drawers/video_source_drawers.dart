...
class _VideoSourceDrawersState extends State<VideoSourceDrawers> {
  ...
  Widget build(BuildContext context) {
    final videoData = dataSource.videoResources.value;
    return Align(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // 网站选择器
            _buildWebsiteSelector(videoData: videoData),
            const SizedBox(height: 16),
            // 剧集列表
            // Expanded(child: _buildVideoSource()),
          ],
        ),
      ),
    );
  ...
  // 数据源选择器
  Widget _buildWebsiteSelector({required List<ResourcesItem> videoData}) {
    return SizedBox(
        height: 40,
        child: Row(
          children: [
...
//       itemCount:
//           widget.videoResources[selectedWebsiteIndex].episodeResources.length,
//       itemBuilder: (context, index) {
//         final resourceItem = widget
//             .videoResources[selectedWebsiteIndex].episodeResources[index];
//         final isLastItem = index ==
//             widget.videoResources[selectedWebsiteIndex].episodeResources
//                     .length -
//                 1;
//
...
//                 currentEpisode,
//                 resourceItem,
//                 widget.videoResources[selectedWebsiteIndex].videoConfig,
//               ),
//
//               // 在最后一项后显示开关按钮
//               if (isLastItem) ...[
...
//                         item,
//                         widget
//                             .videoResources[selectedWebsiteIndex].videoConfig,
//                       ),
//                     );
//                   }),
//               ],
