...
import 'package:anime_flow/core/network/clients/bgm_client.dart';
...
import 'package:anime_flow/shared/models/bangumi/collections_item.dart';
...
import 'package:anime_flow/shared/models/bangumi/me_item.dart';
...
class BgmApi {
  ...
  static Future<SubjectsInfoItem> getSubjectByIdService(int id) async {
    final response =
        await _client.get('$_nextBaseUrl${BgmNextApi.subjects}/$id');
