                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '${(appInfoController.downloadProgress.value * 100)
                                .toStringAsFixed(1)}%',
                            style: TextStyle(
                              fontSize: 14,
                              color: Theme
                      ...
                      if (appInfoController.totalBytes.value > 0)
                        Text(
                          '${FormatTimeUtil.formatBytes(appInfoController
                              .receivedBytes.value)} / ${FormatTimeUtil
                              .formatBytes(appInfoController.totalBytes
                              .value)}',
                          style: TextStyle(
                            fontSize: 12,
                            color: Theme
                  ...
                  ...[
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        if (widget.download.length > 1) const SizedBox(
                            height: 8),
